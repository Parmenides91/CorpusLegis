...
var sql_corpuslegit = builder.AddSqlServer("sqlserver-corpuslegis") // Nombre del CONTENEDOR/RECURSO: nombre interno con el que Aspire identifica al contenedor de SQL Server en el Dashboard
...
var keycloak_corpuslegis = builder.AddKeycloak("keycloak-corpuslegis", 8080)
...
builder.AddProject<Projects.CorpusLegis_Web>("web-blazor-corpuslegis") // TODO: mejor llamarlo "corpuslegis-web-blazor", por si en el futuro hago una de React.
